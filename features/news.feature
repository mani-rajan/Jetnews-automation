...
Feature: JetNews article interactions
  ...
  @android @ios
  Scenario: Open top story and verify headline matches article screen
  ...
  Scenario Outline: Open next home stories and verify expected article headline
  ...
  @like @android @ios
  Scenario: Open top story and verify alert message once like button is tapped
  ...
  @android @shared @ios
  Scenario: Open top story and verify OS share dialog is shown when share is tapped
    Given I open the top story
  ...
  Scenario: Open top story and verify bookmark navigation to home is currently broken
    Given I open the top story
    When I tap the bookmark button on article screen
    Then bookmark should not navigate back to home feed
